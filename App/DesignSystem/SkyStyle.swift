...
struct SkyStyle: Equatable {
    ...
    /// Daytime palettes are kept dark enough that white text stays readable (contrast of at least 4.5:1 at the
    /// lightest point of the gradient).
    static func make(condition: WeatherCondition, isDaytime: Bool) -> SkyStyle {
        ...
        case (.clear, true): (0x1E6FD9, 0x4079A5)
        case (.clear, false): (0x0B1D3A, 0x1F3B63)
        case (.partlyCloudy, true): (0x3F78B5, 0x5B768E)
        case (.partlyCloudy, false): (0x16233B, 0x2E4363)
        case (.cloudy, true): (0x56667A, 0x6A7481)
        case (.cloudy, false): (0x212833, 0x394252)
        case (.fog, true): (0x687481, 0x6E767D)
        ...
        case (.snow, true): (0x5B7592, 0x677584)
